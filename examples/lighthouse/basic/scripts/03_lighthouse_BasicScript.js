...
// An example of customized test results against one URL only
// This test script is customized as follows:
//		- Will run against local file on file system
//		- Will ignore HTMLCS Notices and through the "ignore" option, only run rules 
//		  that are in most alingment with ICT/TTv5 for Web
//		- Will run rules for Axe or HTML Code Sniffer or both via the "runners" option
//---------------------------------------------------------------------------------------
...
vWebSite="file:///C:/_test/TC1005C001.html"
